...
$routes->get('/banners', 'DashboardController::banners');
...
$routes->group('difabel', function($routes)
{
		...
		$routes->get('(:segment)', 'DashboardController::show/$1',['filter' => 'authapi']);
    $routes->post('', 'DashboardController::register',['filter' => 'authapi']);
		$routes->put('(:segment)', 'DashboardController::edit/$1',['filter' => 'authapi']);
    $routes->delete('(:segment)', 'DashboardController::delete/$1',['filter' => 'authapi']);
